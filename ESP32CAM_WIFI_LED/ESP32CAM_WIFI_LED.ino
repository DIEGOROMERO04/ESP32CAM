 ...
 * 
 * Ejercicio LED Externo
 * Modificado por: DIEGO ROMERO
 * FECHA:29/07/2021
 * Componente   PinESP32CAM      Estado logico
 * Led ---------GPIO 12---------On=>LOW, off=>HIGH
 * 
 */
...
// Datos de Red
const char* ssid = "INFINITUMdxuy";  // Pon aquí el nombre de la red a la que deseas conectarte
const char* password = "a18609e906";  // Escribe la contraseña de dicha red
...
int ledAzul=12; //Esta variable controla el led azul externo 
...
void setup() {
  ...
  pinMode (ledAzul,OUTPUT); //Se configura el pin como salida
